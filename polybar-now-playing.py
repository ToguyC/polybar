#!/usr/bin/env python3
# see: https://github.com/d093w1z/polybar-now-playing
import dbus
import signal
import time
...
def update_prefix_suffix(player_name="", status=""):
    global display_prefix, display_suffix, status_paused, players
...
def update_message():
    ...
    message_display_len = 35 if len(players) != 0 else len("No player available")
